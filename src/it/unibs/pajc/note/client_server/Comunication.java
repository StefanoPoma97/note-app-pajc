...
public class Comunication implements Serializable {
	...
	/**
	 * imposta il valore di ValidationError in seguito ad un operazione che richiede
	 * esso come risultato
	 * 
	 * @param er
	 * @author Stefano Poma
	...
	/**
	 * dati il NoteArchive e UserArchive aggiurnati questo metodo crea una risposta
	 * per ogni istanza di COmunication basandosi sulla stringa info capisce che
	 * tipo di informazione viene cercata, la crea, la inserisce in una nuova
