...
//		 //costruttore solo per test, in realt� si appoggia alla classe client che poi
////		 gli da informazioni su archivio note
//		 for (int i=0; i<10; i++){
...
//		// set.add(u);
//		// nota.addSharedUsers(set);
//		//// System.out.println("NOTA CONDIVISA CON "+
////		 nota.getSharedWith().toString());
//		// }
//		// if (i==1){
//		// nota.addLabel("Memo");
//		// }
