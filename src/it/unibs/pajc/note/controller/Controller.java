...
public abstract class Controller<E extends Identifiable> {
	 ...
	 * 
	 * @param id
	 *            l'id secondo il quale cercare l'elemento
	...
	/**
	 * aggiorna una nota esistente, ricevendo la nuova nota e l'ID della nota da
	 * modificare
	 * 
	 * @param e
	 * @param id
	 * @return ValidationError che indica se � stata aggiornata con successo
	 * @author Stefano Poma, Daniele Vezzoli
	 */
	 ...
	 * 
	 * @param id
	 * @return boolean che indica se � stata eliminata con successo
	 * @author Stefano Poma, Daniele Vezzoli
	 */
