...
public class UserController extends Controller<User> {
	 ...
	 * @author Stefano Poma
	 * @param _client
	 * @return Stringa che indica se � avvenuta la connessione
	 */
	 ...
	 * indicata per richiedere il login ottiene una classe Comunication con il
	 * riusultato
	 * 
	 * @param _client
	 * @param _name
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere la creazione di un nuovo utente ottiene una classe
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere tutte le labels associate ad un utente ottiene una
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere l'aggiunta di una nuova Label ottiene una classe
	 * Comunication con il riusultato
	 * 
	 * @author Stefano Poma
	 * @param _client
	 * @param label
	 * @param us
	 * @return true se l'operazione � avvenuta
	 */
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere l'aggiornamento delle labels ottiene una classe
	 * Comunication con il riusultato
	 * 
	 * @author Stefano Poma
	 * @param _client
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere di restituire tutti gli utenti ottiene una classe
	 * Comunication con il riusultato
	 * 
	 * @author Stefano Poma
	 * @param _client
