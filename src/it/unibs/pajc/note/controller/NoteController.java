...
public class NoteController extends Controller<Note> {
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere le note ottiene una classe Comunication con il
	 * riusultato
	 * 
	 * @param _client
	 * @param us
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere le Labels associate a una data nota ottiene una
	 * classe Comunication con il riusultato
	 * 
	 * @param _client
	 * @param title
	 * @param us
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere le note associate ad una specifica Label ottiene una
	 * classe Comunication con il riusultato
	 * 
	 * @param _client
	 * @param label
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per aggiungere una nuova nota ottiene una classe Comunication con il
	 * riusultato
	 * 
	 * @param _client
	 * @param note
	 * @return ValidationError che indica se � avvenuta l'operazione
	 * @author Stefano Poma
	 */
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per aggiornare una nota ottiene una classe Comunication con il
	 * riusultato
	 * 
	 * @param _client
	 * @param note
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere l'ID della nota sulla base del titolo ottiene una
	 * classe Comunication con il riusultato
	 * 
	 * @param _client
	 * @param title
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere la creazione di una nuova nota ottiene una classe
	 * Comunication con il riusultato
	 * 
	 * @author Stefano Poma
	 * @param title
	 * @return ValidationError che indica se � avvenuta l'operazione
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere se una nota e' segnata o no ottiene una classe
	 * Comunication con il riusultato
	 * 
	 * @param _client
	 * @param titolo
	 * @param utente
	 * @return true se � segnata, false se non � segnata
	 * @author Stefano Poma
	 */
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere se una nota e' pubblica o no ottiene una classe
	 * Comunication con il riusultato
	 * 
	 * @param _client
	 * @param titolo
	 * @param utente
	 * @return treu se � pubblica, false se non lo �
	 * @author Stefano Poma
	 */
	...
	/**
	 * * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere un filtro tramite titolo ottiene una classe
	 * Comunication con il riusultato
	 * 
	 * @param _client
	 * @param u
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere un filtro tramite titolo sulla sezione esplora
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere un filtro tramite Pin ottiene una classe Comunication
	 * con il riusultato
	 * 
	 * @param _client
	 * @param u
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere un filtro tramite like ottiene una classe
	 * Comunication con il riusultato
	 * 
	 * @param _client
	 * @param u
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere un filtro tramite like sulla sezione esplora ottiene
	 * una classe Comunication con il riusultato
	 * 
	 * @param _client
	 * @param u
	 * @return ArrayList con le note
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere un filtro sulla data ottiene una classe Comunication
	 * con il riusultato
	 * 
	 * @param _client
	 * @param u
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere un filtro sulla data nella sezione esplora ottiene
	 * una classe Comunication con il riusultato
	 * 
	 * @param _client
	 * @param u
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere un filtro tramite autore ottiene una classe
	 * Comunication con il riusultato
	 * 
	 * @param _client
	 * @param u
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere gli utenti condivisi di una nota ottiene una classe
	 * Comunication con il riusultato
	 * 
	 * @param _client
	 * @param titolo
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere tutte le note presenti ottiene una classe
	 * Comunication con il riusultato
	 * 
	 * @param _client
	 * @param u
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere le note condivise con l'utente selezionato ottiene
	 * una classe Comunication con il riusultato
	 * 
	 * @param _client
	 * @param u
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere una nota comunicando il suo titolo ottiene una classe
	 * Comunication con il riusultato
	 * 
	 * @param _client
	 * @param n
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere una nota tramite il suo titolo al fine di conoscere
	 * quanti like ha ottiene una classe Comunication con il riusultato
	 * 
	 * @param _client
	 * @param n
	 * @param u
	...
	/**
	 * sfruttando la comunicazione con il client crea una classe Comunication
	 * indicata per richiedere una nota tramite il suo ID ottiene una classe
	 * Comunication con il riusultato
	 * 
	 * @param _client
	 * @param ID
	 ...
	 * @param _client
	 * @param ID
	 * @return true se � stata eliminata con successo
	 */
