...
public class MainView {
	...
	/**
	 * metodo che permette di passare nome e password per la creazione di un nuovo
	 * account
	 * 
	 * @param name
	 * @param pass
	 ...
	 * se le label associate all'utente non sono connesse a nessuna nota vengono
	 * eliminate
	 * 
	 * @author Stefano Poma
	 */
	...
	/**
	 * metodo per aggiornare una nota gi� essitente
	 * 
	 * @param n
	 * @param ID
	 * @return Validation error che indica se l'operazione e' avvenuta
	...
	/**
	 * metodo per aggiornare una nota gi� essitente nella sezione esplora
	 * 
	 * @param n
	 * @param ID
	 * @return Validation error che indica se l'operazione e' avvenuta
	 ...
	 * 
	 * @return ArrayList con tutti gli utenti ArrayList di note filtate
	 * @author Stefano Poma
	 */
	...
	/**
	 * data una nota controlla se � condivisa con l'utente in questione
	 * 
	 * @param n
	 * @return true se � condivisa con l'utente selezionato
	 * @author Stefano Poma
	 */
