...
public abstract class Archive<E extends Identifiable> implements Serializable {
	...
	/**
	 * Aggiunge un elemento all'archivio. L'elemento per essere inserito deve essere
	 * valido. Il metodo validate è definito nelle classi {@link Note} e
	 * {@link User}. In seguito è assegnato un ID a ciascun elemento ed infine
	 * questo viene inserito nel database. viene tornato un Enum per capire che
	 * eventuali errori si sono presentati
	 * 
	 * @param e
	 * @return Errors
	 ...
	 * 
	 * @param e
	 *            L'istanza della classe da validare
	...
	/**
	 * Metodo per la gestione degli id Prende l'id max e lo incrementa
	 * 
	 * @param e
	 * @author Daniele Vezzoli
	 */
	 ...
	 * 
	 * @param pred
	 *            Il filtro su cui si basa la ricerca
	 ...
	 * 
	 * @param pred
	 *            La condizione secondo la quale rimuovere gli elementi
